...
func (app *application) createSnippet(w http.ResponseWriter, r *http.Request) {
	...
	// requests. If there are any errors, we use our app.ClientError helper to send // a 400 Bad Request response to the user.
	err := r.ParseForm()
	if err != nil {
	...
	// (or their session has expired) then a new, empty, session for them // will automatically be created by the session middleware.
	app.session.Put(r, "flash", "Snippet successfully created!")

	http.Redirect(w, r, fmt.Sprintf("/snippet/%d", id), http.StatusSeeOther)
}

// func (app *application) backupTemplate(w http.ResponseWriter, r *http.Request) {
